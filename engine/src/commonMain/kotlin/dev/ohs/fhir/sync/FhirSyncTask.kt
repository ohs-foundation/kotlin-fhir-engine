 ...
 * - iOS: pass a factory to [IosSyncScheduler] which bridges to BGTask
 * - Desktop: pass a factory to [DesktopSyncScheduler] which bridges to a coroutine scheduler
 */
 ...
 */
internal suspend fun FhirSyncTask.runSync(
  taskName: String?,
