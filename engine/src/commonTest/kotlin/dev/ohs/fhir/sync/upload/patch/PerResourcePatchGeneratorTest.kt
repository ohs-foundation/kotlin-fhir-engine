...
//
//  @Test
//  fun should_generate_a_single_insert_patch_if_the_resource_is_inserted() = runTest {
...
//
//  @Test
//  fun should_generate_a_single_update_patch_if_the_resource_is_updated() = runTest {
//    val remoteMeta =
//      Meta().apply {
...
//
//  @Test
//  fun `should_generate_a_single_delete_patch_if_the_resource_is_deleted`() = runTest {
//    val remoteMeta =
//      Meta().apply {
//        versionId = "patient-version-1"
//        lastUpdated = Date()
...
//
//  @Test
//  fun should_generate_a_single_insert_patch_if_the_resource_is_inserted_and_updated() = runTest {
//    val patient: Patient = readFromFile(Patient::class.java, "/date_test_patient.json")
//    val insertionLocalChange = createInsertLocalChange(patient)
...
//
//  @Test
//  fun should_generate_no_patch_if_the_resource_is_inserted_and_deleted() = runTest {
//    val changes =
//      listOf(
//        LocalChangeEntity(
//          id = 1,
...
//
//  @Test
//  fun should_generate_no_patch_if_the_resource_is_inserted_updated_and_deleted() = runTest {
//    val changes =
//      listOf(
//        LocalChangeEntity(
//            id = 1,
...
//
//  @Test
//  fun should_generate_a_single_update_patch_if_the_resource_is_updated_twice() = runTest {
//    val remoteMeta =
//      Meta().apply {
//        versionId = "patient-version-1"
//        lastUpdated = Date()
...
//
//  @Test
//  fun should_generate_a_single_update_patch_with_three_elements_of_two_adds_and_one_remove() =
//    runTest {
...
//
//  @Test
//  fun should_generate_a_single_delete_patch_if_the_resource_is_updated_and_deleted() = runTest {
//    val remoteMeta =
//      Meta().apply {
//        versionId = "patient-version-1"
//        lastUpdated = Date()
...
//
//  @Test
//  fun should_throw_an_error_if_a_change_is_done_after_a_resource_is_deleted_locally() = runTest {
//    val changes =
//      listOf(
//        LocalChangeEntity(
//            id = 2,
...
//
//  @Test
//  fun should_throw_an_error_if_a_change_is_done_before_a_resource_is_created_locally() = runTest {
//    val changes =
//      listOf(
//        LocalChangeEntity(
//            id = 3,
