 ...
 * @return A [Flow] of [dev.ohs.fhir.sync.CurrentSyncJobStatus] representing the sync job progress.
 */
 ...
 *   mechanism.
 * @return A [Flow] of [dev.ohs.fhir.sync.PeriodicSyncJobStatus] representing the sync job progress.
 */
